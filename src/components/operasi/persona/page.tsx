...
const highlightKeywords = (text: string): string => {
  const keywords = ['Potong', 'Pasang', 'Gunakan', 'Masukkan', 'Cek', 'Keluarkan', 'Bor', 'Isi', 'Atur', 'Ukur', 'Tentukan', 'Lakukan'];
  let result = text;
  keywords.forEach((kw) => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 sm:gap-6">
        ...
        >
          <h3 className="text-lg sm:text-xl font-semibold mb-3">{step.id}. {step.title}</h3>
