...
export const vanguardSteps: VanguardStep[] = [
  ...
  },
  {
    ...
    images: ["/vanguard_images/vanguard_step_12.png",
  ...
  },
  {
    ...
    images: ["/vanguard_images/vanguard_step_22.png",
  ...
  },
  {
    ...
    title: "Potong Patela",
    description: [
      "Ukur ketebalan patela dengan kaliper.",
      "Potong bagian belakang patela."
    ],
    images: ["/vanguard_images/vanguard_step_29.png"]
  },
  {
    step: 11,
    title: "Ratakan Permukaan Patela",
    description: [
      "Gunakan alat milling dan bushing.",
      "Ratakan tempat implan akan ditempatkan."
    ],
    images: ["/vanguard_images/vanguard_step_29.png"]
  },
  {
  ...
  {
    step: 15,
    title: "Pasang Implan Patela",
    description: [
      "Tempelkan implan ke patela.",
      "Jepit hingga peg masuk dengan baik."
    ],
    images: ["/vanguard_images/vanguard_step_29.png"]
  },
  {
