...
export default function DashboardPage() {
  ...
  const jenisOptions = useMemo(() => ['All', ...Array.from(new Set(data.map(d => d.jenisBiaya)))], [data]);
  ...
  return (
    <motion.div
      ...
      initial="hidden" animate="visible" variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }} transition={{ duration: 0.4 }}
    >
