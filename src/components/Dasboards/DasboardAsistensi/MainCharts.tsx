...
// Disesuaikan dengan struktur data dari Google Apps Script (Sheet1):
// NO, Date, Rumah Sakit, Tindakan Operasi, Operator, Jumlah, STATUS (link Google Drive)
