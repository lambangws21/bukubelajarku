...
export default function DriveImageGrid() {
  ...
  const filteredImages = useMemo(() => {
    return images.filter((img) => {
      ...
      const matchDate = filterDate ? img.date.startsWith(filterDate) : true;
  ...
  if (loading) {
    return (
      <div className="w-full flex justify-center py-10 text-gray-500 dark:text-gray-400">
       <Lottie animationData={monkeyAnimation} loop={true} className="w-48 h-48" />
      </div>
    );
  }
          ...
          >
            ...
            >
              ...
              <div className="p-4 text-sm text-gray-800 dark:text-gray-200">
                ...
                <p className="text-gray-500 dark:text-gray-400">{selectedImage.date}</p>
