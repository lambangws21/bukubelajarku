// HipArthroplastyGuide.tsx (Dark Theme Optimized dengan Fungsi Share dan Tombol Home)
'use client';
...
import { hipProcedureData, thrComponentData, hipAnatomyData, hipStabilityData } from '@/components/operasi/thr/data'; // Sesuaikan path
import { Share2, Home } from 'lucide-react'; // Impor ikon Share2 dan Home
...
const HipArthroplastyGuide: React.FC = () => {
  ...
  return (
    <motion.div
      className="space-y-12 p-4 md:p-10 max-w-6xl mx-auto bg-gray-950 text-gray-100 min-h-screen"
      variants={containerVariants}
      initial="hidden"
      animate="visible"
    >
      {/* HEADER SECTION (Judul, Home Button, dan Share Button) */}
      <motion.div 
        className="flex justify-between items-center border-b-4 border-red-800 pb-3" 
        variants={itemVariants}
      >
        <motion.h1 
            className="text-3xl md:text-4xl font-extrabold text-red-400" 
            variants={itemVariants}
        >
            Panduan HA & THR
        </motion.h1>
