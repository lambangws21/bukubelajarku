...
const FormSchema = z.object({
  ...
  jenisBiaya: z.string().nonempty("Operasi is required"),
  rumahSakit: z.string().nonempty("Rumah Sakit is required"),
  klaim: z.string().nonempty("Klaim is required"),
  jumlah: z.coerce
    .number()
            ...
            <UIForm {...form}>
              ...
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel>Tanggal Advance</FormLabel>
                      <Popover>
                      ...
                      <FormDescription>
                        Pilih tanggal advance yang sudah dikirim.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel>Klaim Oleh</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="klaim oleh" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
